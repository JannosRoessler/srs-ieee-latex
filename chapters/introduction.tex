\begin{sloppypar}
  ...
  Der folgende Abschnitt dient der Erläuterung der Eigenschaften der Zielgruppen in Form von Personas. Es ist ein umfassendes Verständnis dieser Zielgruppen notwendig, um eine Anwendung nutzerzentriert zu entwickeln. Die wichtigsten Zielgruppen des Tages der offenen Tür der Dualen Hochschule Sachsen sind die Studieninteressierten und deren Angehörige. Die Persona der Studieninteressierten wird als primäre Persona definiert und die Persona der Angehörigen als sekundäre Persona gewählt.
  
  \begin{longtable}{|p{3.5cm}|p{3.5cm}|p{3.5cm}|p{3.5cm}|}
  \caption{Primäre Persona Leon} \\ 
  \hline
  \textbf{Leon} 
  &
  \textbf{Soziografische Eigenschaften}
  &
  \textbf{Psychografische Eigenschaften}
  &
  \textbf{Technografische Eigenschaften} \\
  \hline
  \endfirsthead
  \endhead
  
  % Row 1 content
   \raisebox{-\totalheight}{\includegraphics[width=3cm]{Leon.jpg}}
  & 
  \begin{itemize}\setlength\itemsep{0pt}
    \item Geschlecht: männlich
    \item Alter: 19 Jahre
    \item Bildungsstand: Abitur
    \item Erfahrungen und Kenntnisse: grundlegendes Verständnis von digitalen Geräten und Anwendungen
  \end{itemize}
  &
  \begin{itemize}\setlength\itemsep{0pt}
    \item Motive und Wünsche: Orientierung und Transparenz, Suche nach sinnvoller beruflicher Tätigkeit
    \item Werte und Einstellungen: Neugierde, Zurückhaltung, Unsicherheit, Vorsicht
    \item Bedürfnisse und Erwartungen: Zukunftschancen und -sicherheit, Antworten auf Fragen rund um das duale Studium
    \item Befürchtungen und Sorgen: Angst vor Bewertung und Ablehnung
    \item Belastbarkeit: Überforderung mit der Berufswahl
    \item Risikofreude: risikoavers
  \end{itemize}
  &
  \begin{itemize}\setlength\itemsep{0pt}
    \item Einstellung zu Technologie: mit Technologie aufgewachsen
    \item Technische Ausstattung: Smartphone und Laptop
    \item Nutzungs- häufigkeit von Computern und dem Internet: alltäglich
  \end{itemize} \\
  \hline
  % Row 2 content
  &
  \textbf{Geografische Eigenschaften}
  &
  \textbf{Verhaltensorien- tierte Eigenschaften}
  &
  \textbf{Physisch orientierte Eigenschaften} \\
  \hline
  &
  \begin{itemize}\setlength\itemsep{0pt}
  \item Wohnort: Dresden bei seinen Eltern
  \item Land: Deutschland
  \end{itemize}
  &
  \begin{itemize}\setlength\itemsep{0pt}
    \item Nutzung von Medien, Produkten und Services: sowohl digital als auch analog, Inanspruchnahme der persönlichen Beratung durch die Agentur für Arbeit
  \end{itemize}
  &
  \begin{itemize}\setlength\itemsep{0pt}
    \item Motorische und sensorische Fähigkeiten: keine Einschränkungen
  \end{itemize} \\
  \hline
  \end{longtable}
  ...
  \begin{longtable}{|p{3.5cm}|p{3.5cm}|p{3.5cm}|p{3.5cm}|}
  \caption{Sekundäre Persona Christian} \\ 
  \hline
  \textbf{Christian} 
  &
  \textbf{Soziografische Eigenschaften}
  ...
  % Row 1 content
  \raisebox{-\totalheight}{\includegraphics[width=3cm]{Christian.jpg}}
  & 
  \begin{itemize}\setlength\itemsep{0pt}
    \item Geschlecht: männlich
    \item Alter: 45 Jahre
    \item Bildungsstand: akademischer Abschluss
    \item Beruf: Ingenieur
    \item Erfahrungen und Kenntnisse: aus dem Berufsalltag
  \end{itemize}
  &
  \begin{itemize}\setlength\itemsep{0pt}
    \item Motive und Wünsche: Sohn vor Fehlern und Misserfolgen schützen
    \item Werte und Einstellungen: mutig und engagiert, wenig Vertrauen in die Selbstorganisation seines Sohnes
    \item Bedürfnisse und Erwartungen: Antworten auf organisatorische Fragen rund um das Studium seines Sohnes
    \item Befürchtungen und Sorgen: Zukunft seines Sohnes
  \end{itemize}
  &
  \begin{itemize}\setlength\itemsep{0pt}
    \item Einstellung zu Technologie: technologieoffen
    \item Technische Ausstattung: Smartphone
  \end{itemize} \\
  \hline
  % Row 2 content
  &
  ...
  &
  \begin{itemize}\setlength\itemsep{0pt}
  \item Wohnort: Dresden mit seinem Sohn
  \item Land: Deutschland
  \end{itemize}
  &
  \begin{itemize}\setlength\itemsep{0pt}
    \item Nutzung von Medien, Produkten und Services: informiert sich auf der Webseite der DHSN über das mögliche duale Studium seines Sohnes
  \end{itemize}
  &
  \begin{itemize}\setlength\itemsep{0pt}
    \item Motorische und sensorische Fähigkeiten: keine Einschränkungen
